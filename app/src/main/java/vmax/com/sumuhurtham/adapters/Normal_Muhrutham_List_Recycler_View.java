...
public class Normal_Muhrutham_List_Recycler_View extends RecyclerView.Adapter<Normal_Muhrutham_List_Recycler_View.ViewHolders> {

    private String[] muhurtham_list;
    private Context context;

    public Normal_Muhrutham_List_Recycler_View(FragmentActivity activity, String[] all_muhurtham_list) {
        context = activity;
