...
public class BrideActivity extends AppCompatActivity implements CompoundButton.OnCheckedChangeListener {
    ...
    TextView txt_groom_star,txt_groom_paadam, txt_groom_rasi,txt_bride_star,txt_bride_paadam,txt_bride_rasi,txt_country,txt_state,
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.layout_bride);


        findViewById(R.id.back_button).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                BrideActivity.this.finish();
            }
        });
